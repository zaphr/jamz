...
TabPosition.create(:tab => tab, :chord => Chord.where(:name => 'G').first, :column_no => 3, :row_no => 1)  
TabPosition.create(:tab => tab, :chord => Chord.where(:name => 'A').first, :column_no => 4, :row_no => 1)
...
TabPosition.create(:tab => tab, :chord => Chord.where(:name => 'Dm').first, :column_no => 5, :row_no => 3)
TabPosition.create(:tab => tab, :chord => Chord.where(:name => 'F').first, :column_no => 6, :row_no => 3)
...
TabPosition.create(:tab => tab, :chord => Chord.where(:name => 'G').first, :column_no => 1, :row_no => 1)
TabPosition.create(:tab => tab, :chord => Chord.where(:name => 'A').first, :column_no => 2, :row_no => 1)
TabPosition.create(:tab => tab, :chord => Chord.where(:name => 'G').first, :column_no => 3, :row_no => 2)
TabPosition.create(:tab => tab, :chord => Chord.where(:name => 'A').first, :column_no => 4, :row_no => 2)
Song.create(:name => 'Jane Says', :artist => "Jane's Addiction", :youtube_id => "xh-5FI21s6M", :tab => tab)